...
async def slide7():
    with slide7_container:
        ...
        with col2:
            ...
            st.write(f"""
            <div style="color: black;">
                <h1  style="font-size: 16px;">Acumulados das Últimas 72h e Limiares Críticos do PPDC dos Municípios do Estado de São Paulo - Acompanhe <a href="{url}" target="_blank">SIBH</a> </h1>
            </div>
            """,
            unsafe_allow_html=True) 
...
async def slide6_seca(): 
    with slide6_secas:
        ...
        driver.get("https://cth.daee.sp.gov.br/ssdsp/Sistema/AltoTiete")
        ...
        select_element = driver.find_element(By.CSS_SELECTOR, "table.mt-5.bg-white.text-center.table-systems")
        tm.sleep(3)
